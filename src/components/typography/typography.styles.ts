export const variantClasses = {
  ...
  'label-xlarge': 'text-[24px] font-medium leading-[32px] tracking[-0.015em]',
  'label-large': 'text-[18px] font-medium leading-[24px] tracking[-0.015em]',
  'label-medium': 'text-[16px] font-medium leading-[24px] tracking[-0.011em]',
  'label-small': 'text-[14px] font-medium leading-[20px] tracking[-0.006em]',
  ...
  'subheading-small': 'text-[14px] font-medium leading-[20px] tracking[0.06em]',
  'subheading-xsmall':
